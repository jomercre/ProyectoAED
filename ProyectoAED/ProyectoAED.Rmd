...
pacman::p_load(readr,dplyr,ggplot2,vcd,patchwork)
...
```{r, echo=FALSE}
# Importación del archivo en bruto
...
```{r}
var <- c('IDENT','SEXO','EDAD','RAMA','T_UNIV','EST_B12','EST_B16',
