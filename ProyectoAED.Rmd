...
df$RAMA <- factor(df$RAMA, levels=codi_rama, labels=desc_rama) # NA's = 9999
...
```{r}
ggplot(data=df, aes(x = RAMA)) + geom_bar() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1, size = 10)) + 
  scale_y_continuous(limits = c(0, 16000))
ggplot(data=df, aes(x = URAMA)) + geom_bar() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1, size = 10)) +
  scale_y_continuous(limits = c(0, 16000))
```
Graficamos en un gráfico de barras los estados laborales de las personas analizadas.
```{r}
ggplot(data=df, aes(x = TRBPRN1)) + geom_bar() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1, size = 10))
```
...
```{r}
ggplot(data=df, aes(x = T_UNIV)) + geom_bar() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1, size = 10))
```
...
ggplot(data=df_plot, aes(x = HATR_E11)) + geom_bar() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1, size = 10)) +
  facet_wrap(~ T_UNIV)
```
...
ggplot(df_plot, aes(x= TRBPRN1)) + geom_bar() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1, size = 5)) +
  facet_wrap(~URAMA)
```
...
ggplot(df_plot, aes(x=IDIOMAS)) + geom_bar() + facet_wrap(~TRBPRN1) +
  theme(axis.text.x = element_text(angle = 45, hjust = 1, size = 10))
```
...
ggplot(df_plot, aes(x=URAMA)) + geom_bar() + facet_wrap(~TRBPRN1) +
  theme(axis.text.x = element_text(angle = 45, hjust = 1, size = 10))
```
